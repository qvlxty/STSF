...
Если приложению требуется система аутентификации и авторизации (Возможно даже простая RBAC), то во фреймворке уже предусмотрена работа с middleware и методами для аутентификации пользователя.
